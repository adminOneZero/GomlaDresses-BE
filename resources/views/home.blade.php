...
<html lang="en">
    <head>
        ...
        <title>الصفحة الرئيسية</title>
            ...
            <!-- normalize -->
            <link type="text/css" rel="stylesheet" href="{{asset("public/css/normalize.css")}}"/>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul class="header-links col-lg-8 col-12">
                        <li><a href="/login"><i class="fas fa-user-alt"></i>تسجيل الدخول </a></li>
                        <span>|</span>
        ...
        <header>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="img-me">
                            <a href="index.html"><img src="img/AHMED.png" alt=""></a>
                        </div>
                    </div>
        ...
        <nav>
            <div class="container">
                <ul class="main-nav">
                    ...
                    <li><a href="products.html">فساتين زفاف</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4 col-12">
                        ...
                        <a href="products.html">فساتين زفاف</a>
                    </div>
                    <div class="col-sm-4 col-12">
                        <div class="img-me">
                            <div class="overlay"></div>
                        ...
                        <a href="products.html">فساتين سوارية</a>
                    </div>
                    <div class="col-sm-4 col-12">
                        <div class="img-me">
                            <div class="overlay"></div>
                        ...
                        <a href="products.html">فساتين أطفال</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="box">
                            <div class='img-me'>
                                <div class="overlay"></div>
                               <a href="products.html"><img src="img/1.jpg"  alt=""></a>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="box">
                            <div class='img-me'>
                                <div class="overlay"></div>
                                <a href="products.html"><img src="img/5.jpg"  alt=""></a>
                                <i class="far fa-heart"></i>
                            </div>
                            <div class="show-button">
                                <span class="float-right">$900</span>
